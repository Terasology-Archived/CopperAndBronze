...
public class ChalcopyriteOreGeneration extends PocketStructureDefinition implements OreDefinition {
    public ChalcopyriteOreGeneration() {
        super(new UniformPocketBlockProvider(CoreRegistry.get(BlockManager.class).getBlock("CopperAndBronze:ChalcopyriteOre")),
                new PDist(0.8f, 0.08f), new PDist(3f, 1f), new PDist(2f, 0.5f), new PDist(1600f, 200f), new PDist(0f, 0.35f),
