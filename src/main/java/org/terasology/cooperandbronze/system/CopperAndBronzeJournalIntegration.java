...
package org.terasology.cooperandbronze.system;
...
public class CopperAndBronzeJournalIntegration extends BaseComponentSystem {
    private final String chapterId = "CopperAndBronze";
    ...
    public void initialise() {
        ...
        chapterHandler.registerJournalEntry("chalcopyriteCrystalAndStation",
                createTimestampEntryProducer("I found Chalcopyrite Crystal, it is a great source of copper. I should " +
                        "be able crush it in metal station into " +
                        "Chalcopyrite Crystal Dust. Once in that form, I will be able to extract copper out of it to " +
                        "build stronger " +
                        "tools.<l><l>To build the station, I need two Cobblestone blocks side-by-side and use my " +
                        "hammer on them " +
        ...
        chapterHandler.registerJournalEntry("nativeCopperAndStation",
                createTimestampEntryProducer("I found Native Copper. Boy, am I lucky! This is a very rare find and is" +
                        " a pure source of copper. I should be able " +
        ...
        journalManager.registerJournalChapter(chapterId,
                Assets.getTexture("CopperAndBronze:CopperAndBronzeJournal").get(), "Copper and Bronze",
                chapterHandler);
    }
